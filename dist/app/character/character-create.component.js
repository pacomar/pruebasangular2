...
var CharacterCreateComponent = (function () {
    function CharacterCreateComponent(af) {
        var _this = this;
        this.af = af;
        this.af.auth.subscribe(function (auth) { return _this.user = auth; });
        this.characters = af.database.list('/characters/' + this.user.uid);
    }
    CharacterCreateComponent.prototype.save = function (newName, newRace) {
...
exports.CharacterCreateComponent = CharacterCreateComponent;
